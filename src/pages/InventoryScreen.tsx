                    ...
                    <div className='flex flex-col justify-center items-center p-6'>
                        ...
                        <>
                            ...
                            <button
                                ...
                                className="ml-4 btn bg-primary w-5/5"
                            >
                                <svg
                                    viewBox="0 0 16 16"
                                    fill="currentColor"
...
export const InventoryScreen: React.FC<any> = () => {
    ...
    return (
        <>
            ...
            <div className={`${!!cards ? cards.length <= 0 ? 'h-screen' : '' : 'w-screen'} lg:h-screen max-sm:h-lvh lg:flex lg:flex-col lg:overflow-auto`}>
                <NavbarApp />
                <div className="flex flex-col lg:flex-row p-5 h-full">
                    <div className="p-5 lg:w-2/6 md:w-full flex h-full card bg-base-300 rounded-box justify-center items-center">
